...
{
    public partial class Lista_de_salidas : Form
    {
        public Lista_de_salidas()
        {
            InitializeComponent();
            CargarDatos();
        }

        private void Lista_de_salidas_Load(object sender, EventArgs e)
        {
        ...
        private void CargarDatos()
        {
            ...
            string query = "SELECT*  FROM entradas_salidas";
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    dataGridViewSal.DataSource = dataTable;
                }
                catch (Exception ex)
                {
